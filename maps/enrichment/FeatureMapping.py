...
class FeatureMapping(object):
    ...
    def __init__(self, feature_id, dataset_name, chrom_name, chrom_order, pos, empty = False):
    ...
    def __str__(self):
        return " - ".join([self._feature_id, self._dataset_name, str(self._chrom_name)+"/"+str(self._chrom_order), str(self._pos), str(self._empty)])
